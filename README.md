...
const nazwa = {
  name: "Nazwa Aulia P",
  nickname: "Nazwa / Nanaz",
  currentlyLearning: ["Backend Development", "Cybersecurity"],
  passion: "Building things & breaking them (ethically 😄)",
  funFact: "A girl who loves 🟠 orange, Gundam, Tamiya & survival crafting games 🎮"
};
```
...
[![GitHub](https://img.shields.io/badge/GitHub-FF6B00?style=for-the-badge&logo=github&logoColor=white)](https://github.com/nazwaauliap)
